...
1. Finalize the canonical JSON schema.
...
2. Scaffold the extractor project structure.
...
3. Implement workbook reading utilities.
...
10. Run end-to-end extraction and review.
